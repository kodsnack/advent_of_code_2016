...
public class Day14_2 {
    ...
    private void solve(String line) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        for (int i = 0; i < 1000; i++) {
            hashes.add(generateStretchedHash(line, md, i));
        }
        ...
        while (matches < 64) {
            ...
            hashes.add(generateStretchedHash(line, md, i + 1000));
            i++;
        }
    }
    ...
    private HashId generateStretchedHash(String line, MessageDigest md, int i) throws UnsupportedEncodingException {

        String input = line + i;
        for (int j = 0; j < 2016 + 1; j++) {
